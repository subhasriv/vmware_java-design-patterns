...
//		employee.appraise();
		...
		person1.printDetails(false); // Employee's printDetails be called
...
////		person1.appraise(); // Not allowed as Person not aware of appraise method
//
...
//		// Create Employee object of type Appriasable
		...
		Person appraisable = new Employee(100, "Anand", 35, "Male", "Sr.Developer", "IT", 50000);
